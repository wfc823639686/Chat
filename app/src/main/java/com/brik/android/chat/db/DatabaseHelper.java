...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase, ConnectionSource connectionSource) {
        try {
            //            建立Commodity表
            DatabaseTableConfig<OrmMessage> config = DatabaseTableConfigUtil.fromClass(connectionSource, OrmMessage.class);
            TableUtils.createTableIfNotExists(connectionSource, config);
            Log.e(TAG, "onCreate tables -----> ");
//            TableUtils.createTable(connectionSource, OrmMessage.class);
    ...
    public void onUpgrade(SQLiteDatabase sqLiteDatabase, ConnectionSource connectionSource, int oldVersion, int newVersion) {
        try {
            ...
            TableUtils.dropTable(connectionSource, OrmMessage.class, true);
